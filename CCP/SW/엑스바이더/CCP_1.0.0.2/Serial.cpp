...
void CSerial::SendToPAC(DWORD dwReviceTime)
{
	...
	// m_pStatus->
	BYTE_SPLIT( m_bySendBuff[49], m_bySendBuff[50], m_pStatus->GetSpeakerValueEsp() /*m_pPacket->PAC.SPK[0]*/);
	BYTE_SPLIT( m_bySendBuff[51], m_bySendBuff[52], m_pStatus->GetSpeakerValueInt() /*m_pPacket->PAC.SPK[1]*/);
	...
	m_bySendBuff[151] = (BYTE)byCRC[0];
	m_bySendBuff[152] = (BYTE)byCRC[1];
	m_bySendBuff[153] = (BYTE)byCRC[2];
	m_bySendBuff[154] = (BYTE)byCRC[3];
