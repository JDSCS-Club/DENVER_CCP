...
BOOL CPageCI::OnInitDialog()
{
    ...
    m_btnAuto.MoveWindow(10 + (52*0), 250, 52, 52, TRUE);
    m_btnNumber[0].MoveWindow(10 + (52*1), 250, 52, 52, TRUE);
    m_btnNumber[1].MoveWindow(10 + (52*2), 250, 52, 52, TRUE);
    m_btnNumber[2].MoveWindow(10 + (52*3), 250, 52, 52, TRUE);
    m_btnNumber[3].MoveWindow(10 + (52*4), 250, 52, 52, TRUE);
    m_btnNumber[4].MoveWindow(10 + (52*5), 250, 52, 52, TRUE);
    m_btnNumber[5].MoveWindow(10 + (52*6), 250, 52, 52, TRUE);
    m_btnNumber[6].MoveWindow(10 + (52*7), 250, 52, 52, TRUE);
    m_btnNumber[7].MoveWindow(10 + (52*8), 250, 52, 52, TRUE);
    m_btnNumber[8].MoveWindow(10 + (52*9), 250, 52, 52, TRUE);
	m_btnApply.MoveWindow(10 + (52*10), 250, 102, 52, TRUE);
...
void CPageCI::OnActivate(UINT nState, CWnd* pWndOther, BOOL bMinimized)
{
	...
	if( nState == 1 )
	{
		memcpy( m_byCI, m_pPacket->PAC.CI, sizeof(BYTE) * 8 );
		UpdateCarList(true);
	}
}
...
void CPageCI::OnBnClickedBtnApply()
{
	...
	{
		memcpy( m_pPacket->PAC.CI_USER, m_byCI, sizeof(BYTE) * 8 );
	}
}
...
void CPageCI::UpdateCarList(bool bShow)
{
	...
	for(UINT i=0; i<nCarCount; i++)
	{
		...
		strCarNumber[0].Format(_T("%d / %d"), m_pPacket->PAC.CI[i] , m_byCI[i] );
