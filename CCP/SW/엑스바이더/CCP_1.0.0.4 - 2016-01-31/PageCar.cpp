...
//	m_dcPEI6.SetBitmap( _T(IDB_CHECK_PEI6) );
	...
	m_dcPEICALL1.SetBitmap( _T(IDB_CHECK_PEICALL1) );
	m_dcPEICALL2.SetBitmap( _T(IDB_CHECK_PEICALL2) );
	m_dcPEICALL3.SetBitmap( _T(IDB_CHECK_PEICALL3) );
	m_dcPEICALL4.SetBitmap( _T(IDB_CHECK_PEICALL4) );
...
void CPageCar::OnClick_Simulation()
{
	...
	{
		if( m_pParent->m_Status.IsSetCabonKey() && m_pParent->m_Route.GetTrainNumber() )
		{
...
void CPageCar::OnPaint()
{
	...
	if( pCarData )
	{
		...
		else
		{
			...
			if( m_nDisplayMode == 2 || m_nDisplayMode == 3 )
			{
				if( m_pStatus->IsSetPEI() )
				{
					m_pStatus->SetCheckPEI(true);
				}
			}
...
void CPageCar::DrawMarriedACar(CDC *pDC, CAR_DATA *pCarData)
{
	...
	if( CHECK_PID11A(pCarData->DATA) )
	{
		...
		pDC->BitBlt(266, 56, m_dcPID11.Width(), m_dcPID11.Height(), m_dcPID11.GetDC(), 0, 0, SRCCOPY);
	}

	if( CHECK_PID12A(pCarData->DATA) )
	{
		//pDC->BitBlt(371, 200, m_dcPID12.Width(), m_dcPID12.Height(), m_dcPID12.GetDC(), 0, 0, SRCCOPY);	
		pDC->BitBlt(371, 56, m_dcPID12.Width(), m_dcPID12.Height(), m_dcPID12.GetDC(), 0, 0, SRCCOPY);
	}

	if( CHECK_SDI1A(pCarData->DATA) )
	{
		//pDC->BitBlt(148, 283, m_dcSDI1.Width(), m_dcSDI1.Height(), m_dcSDI1.GetDC(), 0, 0, SRCCOPY);	
		pDC->BitBlt(148, 10, m_dcSDI1.Width(), m_dcSDI1.Height(), m_dcSDI1.GetDC(), 0, 0, SRCCOPY);	
	}
	...
	if( CHECK_SDI2A(pCarData->DATA) )
	{
		...
		pDC->BitBlt(465, 10, m_dcSDI2.Width(), m_dcSDI2.Height(), m_dcSDI2.GetDC(), 0, 0, SRCCOPY);	
	}
	...
	if( CHECK_PID13A(pCarData->DATA) )
	{
		...
		pDC->BitBlt(266, 200, m_dcPID13.Width(), m_dcPID13.Height(), m_dcPID13.GetDC(), 0, 0, SRCCOPY);	
	}

	if( CHECK_PID14A(pCarData->DATA) )
	{
		//pDC->BitBlt(371, 56, m_dcPID14.Width(), m_dcPID14.Height(), m_dcPID14.GetDC(), 0, 0, SRCCOPY);	
		pDC->BitBlt(371, 200, m_dcPID14.Width(), m_dcPID14.Height(), m_dcPID14.GetDC(), 0, 0, SRCCOPY);	
	}

	if( CHECK_SDI3A(pCarData->DATA) )
	{
		//pDC->BitBlt(148, 10, m_dcSDI3.Width(), m_dcSDI3.Height(), m_dcSDI3.GetDC(), 0, 0, SRCCOPY);	
		pDC->BitBlt(148, 283, m_dcSDI3.Width(), m_dcSDI3.Height(), m_dcSDI3.GetDC(), 0, 0, SRCCOPY);	
	}
	...
	if( CHECK_SDI4A(pCarData->DATA) )
	{
		...
		pDC->BitBlt(465, 283, m_dcSDI4.Width(), m_dcSDI4.Height(), m_dcSDI4.GetDC(), 0, 0, SRCCOPY);	
	}
...
void CPageCar::DrawMarriedBCar(CDC *pDC, CAR_DATA *pCarData)
{
	...
	if( CHECK_PID11B(pCarData->DATA) )
	{
		...
		pDC->BitBlt(266, 56, m_dcPID15.Width(), m_dcPID15.Height(), m_dcPID15.GetDC(), 0, 0, SRCCOPY);	
	}

	if( CHECK_PID12B(pCarData->DATA) )
	{
		//pDC->BitBlt(371, 200, m_dcPID16.Width(), m_dcPID16.Height(), m_dcPID16.GetDC(), 0, 0, SRCCOPY);	
		pDC->BitBlt(371, 56, m_dcPID16.Width(), m_dcPID16.Height(), m_dcPID16.GetDC(), 0, 0, SRCCOPY);	
	}

	if( CHECK_SDI1B(pCarData->DATA) )
	{
		//pDC->BitBlt(148, 283, m_dcSDI5.Width(), m_dcSDI5.Height(), m_dcSDI5.GetDC(), 0, 0, SRCCOPY);	
		pDC->BitBlt(148, 10, m_dcSDI5.Width(), m_dcSDI5.Height(), m_dcSDI5.GetDC(), 0, 0, SRCCOPY);
	}
	...
	if( CHECK_SDI2B(pCarData->DATA) )
	{
		...
		pDC->BitBlt(465, 10, m_dcSDI6.Width(), m_dcSDI6.Height(), m_dcSDI6.GetDC(), 0, 0, SRCCOPY);	
	}
	...
	if( CHECK_PID13B(pCarData->DATA) )
	{
		...
		pDC->BitBlt(266, 200, m_dcPID17.Width(), m_dcPID17.Height(), m_dcPID17.GetDC(), 0, 0, SRCCOPY);	
	}

	if( CHECK_PID14B(pCarData->DATA) )
	{
		//pDC->BitBlt(371, 56, m_dcPID18.Width(), m_dcPID18.Height(), m_dcPID18.GetDC(), 0, 0, SRCCOPY);	
		pDC->BitBlt(371, 200, m_dcPID18.Width(), m_dcPID18.Height(), m_dcPID18.GetDC(), 0, 0, SRCCOPY);	
	}

	if( CHECK_SDI3B(pCarData->DATA) )
	{
		//pDC->BitBlt(148, 10, m_dcSDI7.Width(), m_dcSDI7.Height(), m_dcSDI7.GetDC(), 0, 0, SRCCOPY);	
		pDC->BitBlt(148, 283, m_dcSDI7.Width(), m_dcSDI7.Height(), m_dcSDI7.GetDC(), 0, 0, SRCCOPY);	
	}
	...
	if( CHECK_SDI4B(pCarData->DATA) )
	{
		...
		pDC->BitBlt(465, 283, m_dcSDI8.Width(), m_dcSDI8.Height(), m_dcSDI8.GetDC(), 0, 0, SRCCOPY);	
	}
...
void CPageCar::DrawPEIMarriedACar(CDC *pDC, CAR_DATA *pCarData)
{
	...
	{
		pDC->BitBlt(214, 10, m_dcPEICALL1.Width(), m_dcPEICALL1.Height(), m_dcPEICALL1.GetDC(), 0, 0, SRCCOPY);	
	}

	if( CHECK_PEICALL2A(pCarData->DATA) )
	{
		pDC->BitBlt(399, 283, m_dcPEICALL2.Width(), m_dcPEICALL2.Height(), m_dcPEICALL2.GetDC(), 0, 0, SRCCOPY);	
	}
}
...
void CPageCar::DrawPEIMarriedBCar(CDC *pDC, CAR_DATA *pCarData)
{
	...
	{
		pDC->BitBlt(399, 283, m_dcPEICALL3.Width(), m_dcPEICALL3.Height(), m_dcPEICALL3.GetDC(), 0, 0, SRCCOPY);	
	}

	if( CHECK_PEICALL2B(pCarData->DATA) )
	{
		pDC->BitBlt(214, 10, m_dcPEICALL4.Width(), m_dcPEICALL4.Height(), m_dcPEICALL4.GetDC(), 0, 0, SRCCOPY);		
	}
...
//	m_dcPEI6.FreeResource();
	...
	m_dcPEICALL1.FreeResource();
	m_dcPEICALL2.FreeResource();
	m_dcPEICALL3.FreeResource();
	m_dcPEICALL4.FreeResource();
}