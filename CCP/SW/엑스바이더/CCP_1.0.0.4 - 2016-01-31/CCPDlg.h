...
enum CAPTION
{
	...
	CAPTION_CONFIG_CI,
	CAPTION_CONFIG_PASSWORD,
	CAPTION_CONFIG_INVALID_PASSWORD,
	CAPTION_CONFIG_NEW_PASSWORD,
	CAPTION_HELP_HONE,
	CAPTION_HELP_TRAIN,
	CAPTION_HELP_CREW,
	CAPTION_HELP_ROUTE,
...
#define	PASSWORD_PATH		( "\\NandFlash\\password.ini" )
...
public:
	...
	void ReadPassword();
	void SavePassword( UINT nNewPassword );
