...
public:
	...
	void	SetCrossTime( int nSetCrossTime )	{ m_nSetCrossTime = nSetCrossTime; }
	...
	BYTE	GetIntSpeaker();
	BYTE	GetExtSpeaker();
	BYTE	GetSpeakerValueEsp();
	BYTE	GetSpeakerValueInt();
	UINT	GetBrightness();
	...
	int 	GetCrossTime()	{ return m_nSetCrossTime; }
