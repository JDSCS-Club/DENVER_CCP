...
public:
	...
	void		SetTrainNumber(UINT	nTrainNumber = 0xFFFF )	
				{	
	...
	UINT		GetOriginStationNo(){ return ( m_bDirUp ? m_nOriginStation_No : m_nDestination_No ); }
	CString		GetOriginStationName(){ return ( m_bDirUp ? m_strOriginStation_Name : m_strDestination_Name ); }
	CString		GetOriginStationCode(){ return ( m_bDirUp ? m_strOrignStation_Code : m_strDestination_Code ); }
	UINT		GetDestinationStationNo(){ return ( m_bDirUp ? m_nDestination_No : m_nOriginStation_No ); }
	CString		GetDestinationName(){ return ( m_bDirUp ? m_strDestination_Name : m_strOriginStation_Name ); }
	CString		GetDestinationCode(){ return ( m_bDirUp ? m_strDestination_Code : m_strOrignStation_Code ); }
