...
;******************************************************************************
;	c:\lang\tms320c3x\511\bin\ac30.exe mpudebug.c C:\Users\JDS_DELL\AppData\Local\Temp\mpudebug.if 
	.file	"mpudebug.c"
	.file	"def.h"
	...
	.eos
	.stag	.fake71,512
	.member	_CREG1,0,9,8,32,.fake72
	.member	_CREG2,32,9,8,32,.fake73
	.member	_CREG3,64,9,8,32,.fake74
	...
	.eos
	.sym	_XR16L784ST,0,8,13,512,.fake71
	.sym	_PXR16L784ST,0,24,13,32,.fake71
	.stag	.fake75,2048
	.member	_xr16Reg,0,56,8,2048,.fake71,4
	.eos
	.sym	_XR16L784BDY,0,8,13,2048,.fake75
	.sym	_PXR16L784BDY,0,24,13,32,.fake75
	.file	"MpuDebug.h"
	.file	"mpudebug.c"
...
;----------------------------------------------------------------------
        ...
        call      DIV_U30
                                        ; Call Occurs
        ldiu      127,r2
        ldiu      @_m_Variable+293,r3
        ldiu      1,r1
        and       @_m_Variable+291,r2
        subri     @_m_Variable+291,r1   ; Unsigned
        push      r3
        ldiu      @_m_Variable+292,r3
        addi      1,r0                  ; Unsigned
        push      r3
        ldiu      @_m_Variable+289,r3
        push      r3
        push      r2
        lsh       -7,r1
        push      r0
...
;----------------------------------------------------------------------
        ldiu      @_m_Variable+245,rs
        ldiu      @_m_Variable+246,r0
        ldiu      @_m_Variable+248,r2
        ldiu      @_m_Variable+247,r1
        push      r2
        push      r1
        push      r0
        ldiu      @CL40,r3
...
;----------------------------------------------------------------------
        ...
        ldiu      255,r3
        ldiu      255,rs
        and       @_m_Variable+247,r3
        ldiu      255,r0
        and       @_m_Variable+246,r1
        and       @_m_Variable+245,rs
        and       @_m_Variable+248,r0
        push      r0
        push      r3
        push      r1
        push      rs
