...
#include <eia709_1.h>   /* To get Byte, Boolean & Status */
#include <queue.h>
#include <node.h>      /* To get AllocateStorage. */
...
Comments:  The item added is direclty placed in queue before calling
...
Reference: None
Purpose:   To access the head of the queue direcly from queue.
           Cients can examine the item directly from queue without
           removing it first.
Comments:  None
******************************************************************/
