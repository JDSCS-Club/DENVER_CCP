...
void CPageNumber::OnClick_Enter()
{
	...
	m_pParent->SendMessage(WM_FROM_PAGE_NUMBER, m_nUseMode, _tstoi( m_strNumber ) );
}
...
{	
	...
	//else if( wparam == PARAM_PASSWORD )			SetUseCrewID();
	//else if( wparam == PARAM_PASSWORD_VOL )		SetUseCrewID();
	//else if( wparam == PARAM_PASSWORD_CI )		SetUseCrewID();
