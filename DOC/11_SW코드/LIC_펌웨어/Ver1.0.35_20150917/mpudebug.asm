...
;* Date/Time created: Tue Nov 17 16:05:20 2015                                *
;******************************************************************************
...
;******************************************************************************
;	c:\lang\tms320c3x\511\bin\ac30.exe mpudebug.c C:\Users\JDS\AppData\Local\Temp\mpudebug.if 
	.file	"mpudebug.c"
	.file	"def.h"
...
;----------------------------------------------------------------------
        ...
        call      DIV_U30
                                        ; Call Occurs
        ldiu      127,r2
        ldiu      @_m_Variable+350,r3
        ldiu      1,r1
        and       @_m_Variable+348,r2
        subri     @_m_Variable+348,r1   ; Unsigned
        push      r3
        ldiu      @_m_Variable+349,r3
        addi      1,r0                  ; Unsigned
        push      r3
        ldiu      @_m_Variable+346,r3
        push      r3
        push      r2
        lsh       -7,r1
        push      r0
...
;----------------------------------------------------------------------
        ldiu      @_m_Variable+307,rs
        ldiu      @_m_Variable+308,r0
        ldiu      @_m_Variable+310,r2
        ldiu      @_m_Variable+309,r1
        push      r2
        push      r1
        push      r0
        ldiu      @CL40,r3
...
;----------------------------------------------------------------------
        ...
        ldiu      255,r3
        ldiu      255,rs
        and       @_m_Variable+309,r3
        ldiu      255,r0
        and       @_m_Variable+308,r1
        and       @_m_Variable+307,rs
        and       @_m_Variable+310,r0
        push      r0
        push      r3
        push      r1
        push      rs
